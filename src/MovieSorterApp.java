...
public class MovieSorterApp {
	...
	public static void main(String[] args) {
		...
		fileReader.readFile("movies.txt");				// Tar ett filnamn till vilken fil som ska öppnas som argument
		...
		fileReader.writeToFile("sorted_movies.txt");	// Tar ett filnamn som den sorterade listan ska sparas till som argument
